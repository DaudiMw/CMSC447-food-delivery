...
class User(Base):
    ...
    addresses = relationship("Address", secondary="user_addresses", back_populates="user") #1 to many
...
class Address(Base):
    ...
    # Relationships
    user = relationship("User", secondary="user_addresses", back_populates="addresses") #many to 1
